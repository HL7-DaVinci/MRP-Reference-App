...
var contextualize = __webpack_require__(/*! ./patient */ "./src/patient.js");
/**
...
function () {
  ...
  function FhirClient(environment, state) {
    ...
    this.patient = {
      ...
      request: function request(requestOptions, fhirOptions, _resolvedRefs) {
        ...
        return _this.patient.id ? _this.request(contextualize(requestOptions, _this), fhirOptions, _resolvedRefs) : Promise.reject(new Error("Patient is not available"));
      }
    }; // encounter api -------------------------------------------------------
  ...
  function () {
    ...
    /*#__PURE__*/
    _regenerator.default.mark(function _callee2(resource) {
  ...
  function () {
    ...
    /*#__PURE__*/
    _regenerator.default.mark(function _callee3(resource) {
  ...
  function () {
    ...
    /*#__PURE__*/
    _regenerator.default.mark(function _callee4(uri) {
  ...
  function () {
    ...
    /*#__PURE__*/
    _regenerator.default.mark(function _callee8(requestOptions, fhirOptions, _resolvedRefs) {
      var _this2 = this;
        ...
        while (1) {
          switch (_context8.prev = _context8.next) {
            ...
            case 5:
              ...
              return _context8.abrupt("return", _request(url, requestOptions) // Automatic re-auth via refresh token -----------------------------
                      ...
                      while (1) {
                        switch (_context7.prev = _context7.next) {
                          ...
                          case 15:
                            ...
                            return _context7.abrupt("return", data.concat(makeArray(nextPage.data || nextPage)));

                          case 18:
                            return _context7.abrupt("return", data.concat(makeArray(nextPage)));
...
var debug = _debug.extend("client:patient");
/**
...
function contextualize(requestOptions, client) {
  var patient = client.patient.id;
  var base = absolute("/", client.state.serverUrl);
  if (!patient) return Promise.reject(new Error("Patient is not available"));

  function contextualURL(url) {
    var type = url.pathname.split("/").pop();
    var params = url.searchParams; // Adding a 'patient' parameter may not be appropriate for all
  ...
  if (typeof requestOptions == "string" || requestOptions instanceof URL) {
    var url = new URL(requestOptions, base);
    return contextualURL(url);
  } else {
    var _url = new URL(requestOptions.url, base);

    requestOptions.url = contextualURL(_url);
